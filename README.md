...
The repository covers the full progression from SQL and exploratory data analysis to classical machine learning, gradient boosting, experiment analysis, model interpretation and ML pipelines.

> 🚧 **Course in progress**
> New projects and modules will be added as I continue through the program.
...
### 2. Python, Data Preprocessing & EDA
...
### 4. Trees, Ensembles & Gradient Boosting
...
### 5. Unsupervised Learning & ML Engineering

#### Module 5

* **Unsupervised learning**
  → [Forecasting Order Delays for a Logistics Operator](Module_5/Forecasting%20order%20delays%20for%20a%20logistics%20operator.ipynb)
...
These projects were completed as part of the [Yandex Practicum Data Science course](https://practicum.yandex.ru/data-scientist/?from=catalog).

The work in this repository is intended to demonstrate practical experience with data analysis, statistical methods, classical machine learning and ML engineering workflows.
